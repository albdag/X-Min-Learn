...
ICON_PATH = pref.ROOT / 'icons'
ICONS = {
    'ACCURACY': ICON_PATH / 'accuracy.png',
    'ADD_MASK': ICON_PATH / 'add_mask.png',
    'ADD_ROI': ICON_PATH / 'add_roi.png',
    'ARROW_DOWN': ICON_PATH / 'arrow_down.png',
    'ARROW_UP': ICON_PATH / 'arrow_up.png',
    'BULLSEYE': ICON_PATH / 'bullseye.png',
    'CARET_DOUBLE_YELLOW': ICON_PATH / 'caret_double_yellow.png',
    'CARET_DOWN_RED': ICON_PATH / 'caret_down_red.png',
    'CARET_UP_GREEN': ICON_PATH / 'caret_up_green.png',
    'CHEVRON_DOWN': ICON_PATH / 'chevron_down.png',
    'CHEVRON_UP': ICON_PATH / 'chevron_up.png',
    'CIRCLE': ICON_PATH / 'circle.png',
    'CIRCLE_ADD': ICON_PATH / 'circle_add.png',
    'CIRCLE_ADD_GREEN': ICON_PATH / 'circle_add_green.png',
    'CIRCLE_DEL_RED': ICON_PATH / 'circle_del_red.png',
    'CLEAR': ICON_PATH / 'clear.png',
    'COPY': ICON_PATH / 'copy.png', 
    'CUBE': ICON_PATH / 'cube.png',
    'DIAMOND': ICON_PATH / 'diamond.png',
    'DICE': ICON_PATH / 'dice.png',
    'EDIT': ICON_PATH / 'edit.png',
    'EXPORT': ICON_PATH / 'export.png',
    'FILE_BLANK': ICON_PATH / 'file_blank.png',
    'FILE_ERROR': ICON_PATH / 'file_error.png',
    'FIX': ICON_PATH / 'fix.png',
    'GEAR': ICON_PATH / 'gear.png',
    'HIDDEN': ICON_PATH / 'hidden.png',
    'HIGHLIGHT': ICON_PATH / 'highlight.png',
    'IMPORT': ICON_PATH / 'import.png',
    'INFO': ICON_PATH / 'info.png',
    'INVERT': ICON_PATH / 'invert.png',
    'LEGEND': ICON_PATH / 'legend.png',
    'LOG': ICON_PATH / 'log.png',
    'LOSS': ICON_PATH / 'loss.png',
    'MASK': ICON_PATH / 'mask.png',
    'MERGE': ICON_PATH / 'merge.png',
    'MINERAL': ICON_PATH / 'mineral.png',
    'OPEN': ICON_PATH / 'open.png',
    'PALETTE': ICON_PATH / 'palette.png',
    'PAN': ICON_PATH / 'pan.png',
    'PASTE': ICON_PATH / 'paste.png',
    'PERCENT': ICON_PATH / 'percent.png',
    'PLOT': ICON_PATH / 'plot.png',
    'RANDOMIZE_COLOR': ICON_PATH / 'randomize_color.png',
    'RANGE': ICON_PATH / 'range.png',
    'REFRESH': ICON_PATH / 'refresh.png',
    'REMOVE': ICON_PATH / 'remove.png',
    'RENAME': ICON_PATH / 'rename.png',
    'RGBA': ICON_PATH / 'rgba.png',
    'ROI': ICON_PATH / 'roi.png',
    'ROI_SEARCH': ICON_PATH / 'roi_search.png',
    'ROW_ADD': ICON_PATH / 'row_add.png',
    'ROW_DEL': ICON_PATH / 'row_del.png',
    'SAVE': ICON_PATH / 'save.png',
    'SAVE_AS': ICON_PATH / 'save_as.png',
    'SCORES': ICON_PATH / 'scores.png',
    'SQUARE': ICON_PATH / 'square.png',
    'STACK': ICON_PATH / 'stack.png',
    'TABLE': ICON_PATH / 'table.png',
    'TEST': ICON_PATH / 'test.png',
    'TEST_SET': ICON_PATH / 'test_set.png',
    'TICK': ICON_PATH / 'tick.png',
    'TRAIN_SET': ICON_PATH / 'train_set.png',
    'VALIDATION_SET': ICON_PATH / 'validation_set.png',
    'WARNING': ICON_PATH / 'warning.png',
    'WRENCH': ICON_PATH / 'wrench.png',
    'ZOOM': ICON_PATH / 'zoom.png',
    'ZOOM_DEFAULT': ICON_PATH / 'zoom_default.png',
    'ZOOM_IN': ICON_PATH / 'zoom_in.png',
    'ZOOM_OUT': ICON_PATH / 'zoom_out.png',
    
# logo folder
    'LOGO_32': ICON_PATH / 'logo' / 'logo_32.png',
    'LOGO_SPLASH': ICON_PATH / 'logo' / 'logo_splash.png',

# panes folder
    'DATA_MANAGER': ICON_PATH / 'panes' / 'data_manager.png',
    'HISTOGRAM_VIEWER': ICON_PATH / 'panes' / 'histogram_viewer.png',
    'MODE_VIEWER': ICON_PATH / 'panes' / 'mode_viewer.png',
    'PROBABILITY_MAP_VIEWER': ICON_PATH / 'panes' / 'probability_map_viewer.png',
    'RGBA_MAP_VIEWER': ICON_PATH / 'panes' / 'rgba_map_viewer.png',
    'ROI_EDITOR': ICON_PATH / 'panes' / 'roi_editor.png',

# qss folder
    'CARET_DOWN': ICON_PATH / 'qss' / 'caret_down.png',
    'CARET_DOWN_GRAY': ICON_PATH / 'qss' / 'caret_down_gray.png',
    'CARET_LEFT': ICON_PATH / 'qss' / 'caret_left.png',
    'CARET_RIGHT': ICON_PATH / 'qss' / 'caret_right.png',
    'CARET_UP': ICON_PATH / 'qss' / 'caret_up.png',
    'CLOSE': ICON_PATH / 'qss' / 'close.png',
    'HANDLE_H': ICON_PATH / 'qss' / 'handle_h.png',
    'HANDLE_V': ICON_PATH / 'qss' / 'handle_v.png',
    'TICK_BLACK': ICON_PATH / 'qss' / 'tick_black.png',
    'UNDOCK': ICON_PATH / 'qss' / 'undock.png',

# tools folder
    'DATA_VIEWER': ICON_PATH / 'tools' / 'data_viewer.png',
    'DATASET_BUILDER': ICON_PATH / 'tools' / 'dataset_builder.png',
    'MINERAL_CLASSIFIER': ICON_PATH / 'tools' / 'mineral_classifier.png',
    'MODEL_LEARNER': ICON_PATH / 'tools' / 'model_learner.png',
    'PHASE_REFINER': ICON_PATH / 'tools' / 'phase_refiner.png'
}
