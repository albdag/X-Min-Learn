...
# TODO list
# message boxes first param (parent) set to self always?
...
import plots
from _base import MineralMap, InputMap
...
class MainWindow(QW.QMainWindow):
    ...
    def __init__(self):
        ...
        self.tabifiedDockWidgetActivated.connect(lambda w: print(w))
    ...
    # ==============================   TOOLBAR   ==============================
        ...
        # TODO import inmap, mmap e pntanals ACTIONS, seguiti da un separator
        ...
        # TODO separator seguito da preference dialog
        # TODO in futuro qui vanno altri tool (e.g. map algebra calculator)
    ...
    # Actions to be performed when item is a data object
        ...
        # TODO Actions to be performed if item holds point data
...
if __name__ == "__main__":
    ...
    loader_bg = QG.QPixmap('Icons/XML_logo.png').scaledToWidth(400)
    flags = QC.Qt.WindowStaysOnTopHint | QC.Qt.FramelessWindowHint
    loader = QW.QSplashScreen(loader_bg, flags=flags)
    loader.show()
    loader.showMessage('\nLoading app...', QC.Qt.AlignHCenter,
                       QG.QColor(pref.IVORY))
